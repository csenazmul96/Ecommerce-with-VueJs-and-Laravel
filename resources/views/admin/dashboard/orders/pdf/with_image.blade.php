...
<html>
    ...
    <body style="width: 100%; height: 500px;">
        @foreach($orders as $order)
                            ...
                            <tr>
                                <td>
                                    @if (sizeof($items[0]->item->images) > 0)
                                        <img src="{{ $items[0]->item->images[0]->thumbs_img }}" alt="Product" style="height: 70px">
                                        {{--<img src="{{ 'data:image/png;base64,%20'.$items[0]->thumbs }}" alt="Product" style="height: 70px">--}}
                                    @else
            ...
            <div class="returnpolicy" style="width: 698px;margin-top:15px;border: 1px solid black;">
                <div class="returntitle" style="padding:5px 10px;background: #efefef;border-bottom: 1px solid black;">Return policy</div>
                <div calss="policy" style="padding:10px; text-align: justify;font-size:11px">
                    {!! $privacy_policy  !!}
                </div>
            </div>
