...
@section('content')
    <form class="form-horizontal" id="form" method="post" action="{{ route('admin_main_banner_add') }}" enctype="multipart/form-data">
        @csrf
        <div class="ly_card banner_item_card">
            <div class="ly_card_heading">
                <h5 class="mb-0"> Add Main Banner</h5>
            </div>
        </div>
...
@section('additionalJS')
    ...
    <script>
        $(function () {
            ...
            var images = <?php echo json_encode($bannerImages); ?>;
            ...
            function updateSort(ids) {
                $.ajax({
                    method: "POST",
                    url: "{{ route('admin_main_banner_sort') }}",
                    data: { ids: ids }
                }).done(function( msg ) {
            ...
            $('#modalBtnEdit').click(function () {
                ...
                $.ajax({
                    method: "POST",
                    url: "{{ route('admin_main_banner_update') }}",
