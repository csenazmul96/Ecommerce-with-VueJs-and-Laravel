    ...
    <form class="form-horizontal" method="post" action="{{ route('admin_edit_item_post', ['item' => $item->id]) }}" id="form" enctype="multipart/form-data">
        ...
        <div class="text_left m15">
            <div class="display_inline mr_0">
                <a class="ly_btn btn_blue text_center min_width_100p" href="{{ url()->previous() }}">Go back to previous page</a>
            </div>
                    ...
                    <div class="ly-row">
                        ...
                        <div class="ly-6 pr_0 pl_60">
                            <div class="form_row">
                                ...
                                <div class="form_inline">
                                    <input disabled type="text" class="form_global" value="{{ $item->slug }}">
                                </div>
                            </div>
                            <div class="form_row">
                                <div class="label_inline required width_150p">
                                ...
                                @else
                                    @if (sizeof($item->images) > 0)
                                        @foreach($item->images as $img)
                                            <li class="img-item">
                                                <div class="image-item">
                                                    <img class="img-thumbnail img" src="{{ Storage::url($img->thumbs_image_path) }}">
                                                    <select class="form_global image-color" name="imageColor[]">
                                                        <option value="">Color [Default]</option>
                                                    </select>
                                                    <br>
