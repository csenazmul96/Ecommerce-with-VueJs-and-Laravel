        ...
        <table style="table-layout: fixed;">
            <tr>
                <td style="text-align: center;">
                    ...
                    <p style="text-align: left; font-weight: 400;"> <span style="font-weight: 300;">Dear</span>  ({{ $order->user->first_name }} {{ $order->user->last_name }}) <br> Thank you so much for your recent purchase at shophologram.com. We will let you know as soon as your order is on its way.  We thank you for your patience and apologize for any inconvenience.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
            ...
            <tr>
                <td style="width: 100%;">
                    <table style="font-weight: 300; width: 100%; text-align: left;">
                        <tr>
                            <th style="border-bottom:1px solid #EFEFEE; padding-bottom: 10px; font-weight: 300; width: 50%;">Your Items</th>
                            <th style="border-bottom:1px solid #EFEFEE; padding-bottom: 10px; font-weight: 300; width: 15%;">Qty</th>
                            ...
                            <tr>
                                <td style="border-bottom:1px solid #EFEFEE; ">
                                    <div class="product_img">
                                        ...
                                        @endif
                                        <h4 style="font-weight: 400; margin-bottom: 0;">{{ $item->item->style_no }}</h4>
                                        @if(!empty($item->color_name))
                                            <p style="margin-top: 0;margin-bottom: 0px;">{{ $item->color_name }}</p>
                                        @endif
                                    </div>
                                </td>
