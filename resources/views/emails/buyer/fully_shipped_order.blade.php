...
<head>
    ...
    <title>Fully Shipped Order</title>
</head>
    <style>
        ...
        <table style="table-layout: fixed;">
            <tr>
                <td style="text-align: center;">
                    ...
                    @endif
                    <h1 style="margin-top: 30px; font-size: 30px; text-transform: uppercase; font-weight: 500;">SHIPPING DETAILS</h1>
                    <h4 style="margin-top: 0px; margin-bottom: 40px; font-size: 15px;">Your order from Hologram Nails has been shipped.</h4>
                    <p style="text-align: left; font-weight: 400;"> <span style="font-weight: 300;">Dear</span>  ({{ $order->user->first_name }} {{ $order->user->last_name }}) <br> your order has been shipped. <br>
