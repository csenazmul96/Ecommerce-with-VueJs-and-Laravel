        ...
        <table style="table-layout: fixed;">
            <tr>
                <td style="text-align: center;">
                    ...
                    @endif
                    <h1 style="margin-top: 30px; margin-bottom: 10px; font-size: 30px; text-transform: uppercase; font-weight: 500;">CANCELLED ORDER</h1>
                </td>
            </tr>
            ...
            <tr>
                <td style="width: 100%;">
                    ...
                    <h1 style="margin-top: 0px; margin-bottom: 40px; font-size: 30px; font-weight: 500;">Your order has been canceled.</h1>
                    <p style="font-weight: 300;">This email is a formal request to cancel the <strong>#{{ $order->order_number }}</strong> that you placed on {{ $order->created_at->format('d/m/Y') }}. It is for (${{ $order->total }}).</p>
                    <p style="font-weight: 300;">We'll credit your account within 10 business days. If you have any questions, just send us email info@shophologram.com</p>
