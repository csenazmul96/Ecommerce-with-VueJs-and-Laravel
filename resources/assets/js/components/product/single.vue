    ...
    <span class="masterview" v-if="renderComponent">
      ...
      <section class="product_single_area">
            ...
            <div class="product_single_right">
                  <p class="p_cat" v-if="SingleProduct.product">{{SingleProduct.product.brand.name}}</p>
                  ...
                  <div class="add_size">
                        <div class="size_box" v-if="SingleProduct.itemsize && SingleProduct.itemsize">
                              <label>Size</label>
                              <select class="form-control size_selector" v-model="form.size" name="size" >
                                    <option>Choose an Option...</option>
                                    <option v-for="size in SingleProduct.itemsize" :value="size.id" :key="size.id"> {{size.name}} / {{size.item_size}}</option>
                              </select>
                        </div>
                        <div class="size_box color_box"  v-if="SingleProduct.colors && SingleProduct.colors" >
                              <label>Color </label>
                  ...
                  <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" v-if="SingleProduct.product">
                              {{SingleProduct.product.details}}
                        </div>
                        <div class="tab-pane fade" id="SizeChart" role="tabpanel" aria-labelledby="profile-tab" v-if="SingleProduct.sizechart" v-html="SingleProduct.sizechart.content">

                        </div>
                        <div class="tab-pane fade" id="Returns" role="tabpanel" aria-labelledby="contact-tab" v-if="SingleProduct.returns" v-html="SingleProduct.returns.content">
                        </div>
                  </div>
                  </div>
            </div>
      </section>
      <section class="related_product_area" v-if="SingleProduct.relatedItem">
...
export default {
    name:'Header',
    metaInfo: {
            title: 'dfgdfgfd'+this.metatitle,
            meta: [
                  { vmid: 'description', name: 'description', content: this.metatitle }
            ]
      },
    data(){
            return{
            ...
            singleItemData(){
                ...
                this.NewItemSlider = this.Item.images
                  if(this.Item.default_img){
                        this.default_img = this.Item.default_img.value;
                  }
