<template>
    <!-- ============================
        START USER SECTION
    ============================== -->
    <div class="header_account h_o_dropdown" :class="{has_logged_in:isLoggedIn}" id="user">
        <div class="header_account_inner" v-if="!isLoggedIn && showModalType == 'login'">
            ...
            <div class="form_inline">
                ...
                <input type="password" id="staticEmail" class="form-control" placeholder="Password" v-model="buyerInput.password" @keyup="checkForEnter">
            ...
            <div class="d_flex_center mt_10 mb_10">
                <a href="#" @click="changeModal('forgetPassword')" class="text-center td_underline tt_u">Forgot Password</a>
            </div>
            <p  class="text-center tt_u mb_10">or</p>
            <div id="gSignInWrapper">
                <button id="btn_google" class="btn_google mb_5"><span><i class="fab fa-google"></i></span> <span>sign in with Google</span></button>
            </div>
        ...
        <div class="header_account_inner" v-else-if="!isLoggedIn && showModalType == 'register'">
            ...
            <div class="form_inline">
                ...
                <input type="password" id="Password" class="form-control" placeholder="Password" v-model="buyerRegisterInput.password" @keyup="checkForEnter">
                <small v-for="(formError, errorIndex) in formErrors['password']" :key="'error_name_'+errorIndex"><span v-if="errorIndex == 0">{{formError}}</span></small>
            </div>
            <div class="form_inline">
                <label for="password_confirmation">Confirm Password</label>
                <input type="password" class="form-control" id="password_confirmation" placeholder="Confirm Password" v-model="buyerRegisterInput.password_confirmation" @keyup="checkForEnter">
    ...
    export default {
        ...
        mounted(){
            ...
            gapi.load('auth2', function(){
                ...
                tempThis.attachGoogleSignIn(document.getElementById('btn_google'));
            });
